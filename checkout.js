...
let product = sanpham.map(item => {
    ...
    <tr class="cart-row">
        ...
        <td class="item-price">${item.price} đ</td>
        <td>
            <div class="qty">
...
if(document.readyState == 'loading'){
    ...
    document.getElementsByClassName('item-total')[0].innerText = tempTotal + ' đ'
    }
}
...
function updateCartTotal(){
    ...
    document.getElementsByClassName('item-total')[0].innerText = total + ' đ'
}
function updateQty(){
